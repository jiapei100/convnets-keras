...
def VGG_16(nb_classes=2, weights_path=None, heatmap=False):
    model = Sequential()
    if heatmap:
    ...
    if heatmap:
        ...
        model.add(Dropout(0.5))
        model.add(Dense(output_dim=nb_classes, name='dense_3'))
...
def VGG_19(nb_classes=2, weights_path=None, heatmap=False):
    model = Sequential()
